...
const router = createBrowserRouter(
  [
    ...
    },
    {
      path: "/assets",
      element: <MainLayout />,
      children: [{ index: true, element: <Assets /> }],
    },
    {
      path: "/requests",
      element: <MainLayout />,
    ...
    },
    {
      ...
      element: <MainLayout />,
      children: [{ index: true, element: <Vulnerabilities /> }],
    },
    {
      path: "/analytics",
      element: <MainLayout />,
    ...
    },
    {
      path: "/analyticskr",
      element: <MainLayout />,
      children: [{ index: true, element: <Analyticskr /> }],
    },
    {
      path: "/announcements",
      element: <MainLayout />,
    ...
    },
    {
      path: "/help",
      element: <MainLayout />,
      children: [{ index: true, element: <Help /> }],
    },
  ],
  {
    basename: import.meta.env.MODE === "production" ? "/VMP" : "/",
  }
);
